                ...
                <div className="navbar w-full h-1/10 bg-black bg-opacity-30 flex items-center justify-end">
                    <div className="w-1/2 flex h-full">
                        ...
                        <div className="w-2/5 flex justify-around h-full items-center">
                            <Link to="/signup" className="text-gray-400 text-semibold hover:text-white hover:underline">Sign Up</Link>
                            <Link to="/login" className="bg-white h-2/3 px-8 flex items-center justify-center rounded-full font-semibold cursor-pointer">Log In</Link>
                        </div>
                    </div>
                </div>
